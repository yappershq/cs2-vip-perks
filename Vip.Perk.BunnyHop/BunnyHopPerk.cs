...
internal sealed class BunnyHopPerk : IVipPerk
{
    ...
    [
        new VipPerkSetting("duration", "Duration (s)", VipPerkSettingType.Float, "5.0", "0.5", "30.0"),
        new VipPerkSetting("maxSpeed", "Max Speed", VipPerkSettingType.Float, "350.0", "100.0", "600.0"),
    ];
