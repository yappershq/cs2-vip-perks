...
internal sealed class InterfaceBridge
{
    ...
    internal IHitMarkShared?   HitMarkShared { get; private set; }
    ...
    internal bool Resolve()
    {
        ...
        HitMarkShared ??= SharpModuleManager.GetOptionalSharpModuleInterface<IHitMarkShared>(IHitMarkShared.Identity)?.Instance;
        return VipShared is not null && PerkRegistry is not null && HitMarkShared is not null;
    }
}
